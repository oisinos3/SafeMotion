...
Since I built this from separate scripts for different uses - I have the original scripts and readme's in their folders, **Apply Scale Script** and **Quick Bone Renamer**.
